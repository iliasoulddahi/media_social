    ...
    <!-- navbar -->
    <div class="flex justify-between bg-blue-400 w-full h-12" id="navbar">
        ...
        <div class="flex justify-between items-center absolute bg-blue-400 w-60 h-12 left-1/2 top-1 ">
